...
if(document.getElementById('buttonEditUser')){

    if(localStorage.getItem('login') === nombre_usuario){
        document.getElementById('buttonEditUser').style.display = 'block';
    }
    else{
        document.getElementById('buttonEditUser').style.display = 'none';
    }
}
